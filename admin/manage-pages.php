...
<head>
	...
	<title>Motor Rental Portal | Admin Buat Brand</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kelola Pages </h2>
                  ...
                  <option value="manage-pages.php?type=faqs">FAQs</option>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Page terpilih</label>
												<div class="col-sm-8">
						<?php
			...
			?>
									...
									<div class="form-group">
												<label class="col-sm-4 control-label">Page Detail </label>
												<div class="col-sm-8">
...
?>
											...
											<div class="form-group">
												...
												<button type="submit" name="submit" value="Update" id="submit" class="btn-primary btn">Perbaharui</button>
												</div>
											</div>
