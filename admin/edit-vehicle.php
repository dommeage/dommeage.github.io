...
<head>
	...
	<title>Motor Rental Portal | Edit Kendaraan</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Model Tahun<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Aksessoris</div>
<div class="panel-body">
...
<label for="inlineCheckbox1"> Helm </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="airconditioner" value="1">
<label for="inlineCheckbox1"> Lampu LED </label>
</div>
<?php } ?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox2"> Helm </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox1" name="powerdoorlocks" value="1">
<label for="inlineCheckbox2"> Socket charger handphone </label>
</div>
<?php }?>
</div>
<div class="col-sm-3">
...
<label for="inlineCheckbox1"> Shockbreaker </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Alarm</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Knalpot racing </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Lampu LED </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Box motor </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Jok motor </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Windshield </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
