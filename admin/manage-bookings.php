...
<head>
	...
	<title>Motor Rental Portal |Admin Manage testimoni   </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Info Booking</div>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Apakah Anda benar-benar ingin mengkonfirmasi pemesanan ini')"> Konfir</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Apakah Anda benar-benar ingin Membatalkan Pemesanan ini')"> Batal</a>
</td>
